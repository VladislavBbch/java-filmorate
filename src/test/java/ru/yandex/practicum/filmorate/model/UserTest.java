...
public class UserTest {
    ...
    public void shouldValidateId() {
        user = new User(-1L, "test@test.ru", "Login", "Name", LocalDate.parse("1990-12-24"));
    ...
    public void shouldValidateEmail() {
        user = new User(1L, null, "Login", "Name", LocalDate.parse("1990-12-24"));
        ...
        user = new User(1L, "", "Login", "Name", LocalDate.parse("1990-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
        ...
        user = new User(1L, "test.ru", "Login", "Name", LocalDate.parse("1990-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
    ...
    public void shouldValidateLogin() {
        user = new User(1L, "test@test.ru", null, "Name", LocalDate.parse("1990-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
        ...
        user = new User(1L, "test@test.ru", "", "Name", LocalDate.parse("1990-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
        ...
        user = new User(1L, "test@test.ru", "Login with spaces", "Name", LocalDate.parse("1990-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
    ...
    public void shouldValidateBirthday() {
        user = new User(1L, "test@test.ru", "Login", "Name", null);
        ...
        user = new User(1L, "test@test.ru", "Login", "Name", LocalDate.parse("2100-12-24"));
        validates = validator.validate(user);
        validate = validates.iterator().next();
