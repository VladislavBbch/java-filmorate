...
DROP TABLE IF EXISTS  LIKES, FRIENDS, FILMS_GENRES, REVIEWS_LIKES, RATINGS, FILMS, USERS, GENRES, REVIEWS, DIRECTORS, FILMS_DIRECTORS, EVENT_TYPES, OPERATIONS, EVENTS;
