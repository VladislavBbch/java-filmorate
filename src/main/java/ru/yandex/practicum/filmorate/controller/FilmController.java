...
public class FilmController {
    ...
    public void addLike(@PathVariable Long id, @PathVariable Long userId) {
        log.info("Начало обработки запроса на добавление лайка фильму: " + id + " от пользователя: " + userId);
    ...
    public void deleteLike(@PathVariable Long id, @PathVariable Long userId) {
        log.info("Начало обработки запроса на удаление лайка фильму: " + id + " от пользователя: " + userId);
